...
const avatarOptions = [
  { id: 1, color: "bg-primary", initials: "TU" },
  { id: 2, color: "bg-success", initials: "ME" },
  { id: 3, color: "bg-danger", initials: "YO" },
  { id: 4, color: "bg-warning", initials: "US" },
  { id: 5, color: "bg-info", initials: "HI" },
  { id: 6, color: "bg-secondary", initials: "GO" },
  { id: 7, color: "bg-dark", initials: "BY" },
  { id: 8, color: "bg-purple", initials: "OK" },
]
...
export default function LobbyPage() {
  ...
  if (showChat) {
    return <Chat userAvatar={selectedAvatar} username={username} />
  }
              ...
              <div className="card-body p-5">
                ...
                <div className="mb-4">
                  ...
                  <div className="d-flex justify-content-between mt-2">
                    ...
                    <small className="text-muted">{username.length}/20</small>
                  </div>
                </div>
